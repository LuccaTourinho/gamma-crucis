    ...
    <div className='flex flex-col items-center w-[1440px] h-full bg-green-600 p-6 rounded-xl'>
      {
        !gameover ? (
          ...
          <div className='flex flex-col items-center w-full p-3'>
            ...
            <h1 className='text-lg font-bold text-black'>SANITATION</h1>
            <h1 className='text-lg font-bold text-black'>Money: $ {money}</h1>
            <h1 className='text-lg font-bold text-black'>Water Quality: <span className={`${waterQuality == 'Very High - pH 7.4' ? 'text-sky-400' : ''}
            ...
            your sewage treatment plant on for 30 consecutive days.
            </p>
            <button 
          ...
          >
            ...
            <span className='text-xl text-cyan-300 uppercase'>Click here to know more.</span>
          </p>
            </div>
          </Link>
        )
