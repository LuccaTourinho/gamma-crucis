  ...
  return (
    <div className='flex flex-col xl:flex-row items-center justify-center w-[1440px] border-2 border-black h-full text-black'>
      ...
      <div className='w-full h-full bg-cyan-300 flex flex-col items-center justify-around px-0.5 text-2xl'>
        ...
        <p>DAYS: <span className='font-bold'>{days}</span> </p>
        <p>TOTAL TAXES REVENUE: <span className='font-bold'>${totalTaxes}</span> </p>
        <p>NUMBER OF CONTAMINED BY TOXIC METALS: <span className='text-2xl text-yellow-400 font-bold'>{contamination}</span></p>
        <p>PROBABILITY OF ENVIRONMENTAL DISASTER: <span className='text-red-600 font-bold'>{naturalDisaster}%</span></p>
